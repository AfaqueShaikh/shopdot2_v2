...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="detailed_image[]" class="form-control" multiple>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group has-danger">
                                            <div class="form-group">
                                                ...
                                                <div class="form-check">
                                                    <input id="offer_yes" name="offer" onclick="offerAvailable()" value="1" type="radio" class="">
                                                    <span class="custom-control-indicator"></span>
                                                    <span class="custom-control-description">Yes</span>
                                                    <input id="offer_no" name="offer" onclick="offerAvailable()" value="0" type="radio" checked class="">
                                                    <span class="custom-control-indicator"></span>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-4" id="start_date">
                                        <div class="form-group">
                                            ...
                                            <input type="date" value="<?php echo e(old('start_date')); ?>" name="start_date" class="form-control" placeholder="">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-4" id="end_date">
                                        <div class="form-group">
                                            ...
                                            <input type="date" value="<?php echo e(old('end_date')); ?>" name="end_date" class="form-control" placeholder="">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.brand', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\shopdot-1\app\Modules/Product/resources/views/create.blade.php ENDPATH**/ ?>