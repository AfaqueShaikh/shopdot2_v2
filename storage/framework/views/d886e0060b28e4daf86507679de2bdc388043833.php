...
<head>
    ...
    <link href="<?php echo e(url('/public')); ?>/css/jquery-ui.css" rel="stylesheet" />
...
<!-- Main wrapper  -->
<div id="main-wrapper">
    <?php echo $__env->make('layouts.retailer-header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('layouts.retailer-left-menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <div class="page-wrapper">
        <?php echo $__env->yieldContent('content'); ?>
    </div>
    <?php echo $__env->make('layouts.retailer-footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</div>
    <!-- All Jquery -->
    ...
    <script src="<?php echo e(url('/public')); ?>/js/lib/html5-editor/wysihtml5-0.3.0.js"></script>
    <script src="<?php echo e(url('/public')); ?>/js/lib/html5-editor/bootstrap-wysihtml5.js"></script>
    <script src="<?php echo e(url('/public')); ?>/js/lib/html5-editor/wysihtml5-init.js"></script>
    <script src="<?php echo e(url('/public')); ?>/js/jquery-ui.js"></script>
    <!-- scripit init-->
...
<?php /**PATH F:\xampp\htdocs\shopdot\resources\views/layouts/retailer.blade.php ENDPATH**/ ?>