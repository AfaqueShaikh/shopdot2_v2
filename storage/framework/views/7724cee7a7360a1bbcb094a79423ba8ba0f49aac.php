                ...
                columns: [
                    ...
                    {data: "delete",
                        render: function (data, type, row) {
                            if (type === 'display') {
                                return '<a  class="btn btn-primary btn-xs" title="edit" href="<?php echo e(url("brand/product/edit/")); ?>/' + row.id + '"><i class="fa fa-pencil"></i> Edit</a><form id="delete_' + row.id + '" action="<?php echo e(url("brand/product/delete/")); ?>/' + row.id + '"><button type="button" class="btn btn-danger btn-xs" onclick="confirmDelete(' + row.id + ')"><i class="fa fa-trash"></i> Delete</a></form>';
                            }
                            return data;
                        },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.brand', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\shopdot-1\app\Modules/Product/resources/views/list.blade.php ENDPATH**/ ?>