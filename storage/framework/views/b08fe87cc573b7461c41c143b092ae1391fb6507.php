              ...
              <div class="info-window">
                ...
                <div class="info-window__icon">
                  <svg class="icon green">
                    <use xlink:href="<?php echo e(url('public/front/images/sprite.svg#icon-email-verified"></use>
                  </svg>
                </div>
              </div>
              <form method="POST" action="{{ route('login')); ?>" class="sign__form form">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
 ...
 ?><?php /**PATH F:\xampp\htdocs\shopdot\resources\views/auth/login-confirm.blade.php ENDPATH**/ ?>