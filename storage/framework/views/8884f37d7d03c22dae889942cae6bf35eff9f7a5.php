...
<div class="header">
    <nav class="navbar top-navbar navbar-expand-md navbar-light">
        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="<?php echo e(url('/brand/dashboard')); ?>">
                <!-- Logo icon -->
                <b><h3>Shopdot</h3></b>
                <!--End Logo icon -->
                <!-- Logo text -->
...
<!-- End header header --><?php /**PATH C:\wamp64\www\shopdot\resources\views/layouts/brand-header.blade.php ENDPATH**/ ?>