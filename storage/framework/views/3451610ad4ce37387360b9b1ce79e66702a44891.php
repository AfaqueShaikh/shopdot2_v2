    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            dataTable = $('#product').DataTable({
                processing: true,
                serverSide: true,
                ajax: "<?php echo e(url('retailer/retailer-product/data')); ?>",
                columns: [
        ...
        function requestToAccess(id) {
            $.ajax({
                url:"<?php echo e(url('/retailer/request-access')); ?>",
                data:{
                    id: id,
                },
        ...
        function importProduct(id) {
            $.ajax({
                url:"<?php echo e(url('/retailer/product/import')); ?>",
                data:{
                    id: id,
                },
                success: function (result) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.retailer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\shopdot\app\Modules/RetailerProduct/resources/views/list.blade.php ENDPATH**/ ?>