...
<head>
    ...
    <title>ShopDot - Welcome To Dashboard</title>
    <link rel="icon"
        ...
        <section class="section info-bar">
            <div class="container info-bar-container">
                ...
                @if(isset($info->invited_brands_email))
                    <div class="info-bar__item category-name">
                        @php
                            $exploded_invited_email = explode(',',$info->invited_brands_email);
                        @endphp
                        <div class="info-bar__icon">
                            <svg class="icon">
                                <use xlink:href="images/sprite.svg#icon-thump--up"></use>
                        ...
                        <div class="info-bar__text">
                            @if(count($exploded_invited_email) > 1)
                                <p>{{$exploded_invited_email[0]}}, +{{count($exploded_invited_email) - 1}}</p>
                            @else
                                <p>{{$exploded_invited_email[0]}}</p>
                            @endif
        ...
        <section class="section subheader">
            <div class="container subheader-container">
                ...
                <div class="steps">
                    ...
                    <div class="step done">Invite Brands</div>
                </div>
            </div>
        </section>
                ...
                <div class="primary__content">
                    <div class="text-message text-center">
                        @if(Auth::user()->is_profile_completed == "1")
                            <p>Thank you for inviting Brands that you love. Let’s start selling!</p>
                        @else
                            <p>You can invite the Brands that you love later from your Dashboard.</p>
                        @endif
                    </div>
                    <div class="primary__text">
                        <a href="javascript:void(0);" class="button button-primary">To Your Dashboard</a>
                    </div>
