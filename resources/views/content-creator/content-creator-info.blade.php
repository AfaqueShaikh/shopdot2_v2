                ...
                <div class="primary__content">
                    ...
                    <div id="error-div" style="display: none;">
                        ...
                        <div class="retailer__text">
                            <a href="{{url('/content-creator/info')}}" class="button button-primary">Back to ShopDotApp.com</a>
                        </div>
                    </div>
                    ...
                    <div id="form-div">
                        ...
                        <br>
                        <form method="POST" action="{{url('/content-creator/info')}}" id="content-creator-info-form" class="primary__form form">
                            @csrf
                            <div class="form__field form__field--floating-label">
                                <input type="text" name="business_name" id="business_name" @if(isset($info)) value="{{$info->business_name}}" @endif placeholder="Business name" required>
                                <label for="business_name">Business name</label>
                            </div>
                            <label for="business_name" class="error"></label>
                            <div class="form__field form__field--floating-label">
                                <input type="text" name="website_address" id="website_address" @if(isset($info)) value="{{$info->website_address}}" @endif placeholder="Website address" required>
