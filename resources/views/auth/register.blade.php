        ...
        <div class="sign__content">
          ...
          <div class="text-message text-center">
            ...
            <div class="form__field form__field--half form__field--floating-label">
              <input type="text" name="first_name" value="{{ old('first_name') }}" id="f-name" placeholder="First name" required>
            ...
            @enderror
            <div class="form__field form__field--half form__field--floating-label">
              <input id="l-name" type="text"  placeholder="Last name" name="last_name" value="{{ old('last_name') }}" required >
