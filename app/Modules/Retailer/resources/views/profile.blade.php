                    ...
                    <div class="tab-content">
                        <div class="tab-pane @if(!(Session::has('bank-setting') || Session::has('business-setting') ||  Session::has('shipping'))) active @endif" id="credential" role="tabpanel">
                            <div class="card-body">
                                ...
                                @endif
                                <form class="form-horizontal form-material" method="post" action="{{url('retailer/update/account-credential')}}">
                                    @csrf
                        ...
                        <div class="tab-pane @if(Session::has('bank-setting')) active @endif" id="bank-setting" role="tabpanel">
                            <div class="card-body">
                                ...
                                @if(Session::has('success'))
                                    <p class="alert {{ Session::get('alert-class', 'alert-success') }}">{{ Session::get('success') }}</p>
                                @endif
                                <form class="form-horizontal form-material" method="post" action="{{url('retailer/update/bank-detail')}}">
                                    @csrf
                                    <div class="form-group">
                        ...
                        <div class="tab-pane @if(Session::has('business-setting')) active @endif" id="business-setting" role="tabpanel">
                            <div class="card-body">
                                ...
                                @if(Session::has('success'))
                                    <p class="alert {{ Session::get('alert-class', 'alert-success') }}">{{ Session::get('success') }}</p>
                                @endif
                                <form class="form-horizontal form-material" method="post" action="{{url('retailer/update/business-detail')}}">
                                    @csrf
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="retailer_name" value="@if(Auth::user()->businessDetails){{Auth::user()->businessDetails->brand_name}}@else {{Auth::user()->name}}@endif" class="form-control form-control-line">
                                            @error('retailer_name')
                                            <label class="text text-danger">{{ $message }}</label>
                                            @enderror
                                        </div>
